...
class MVVMDetailView: UIView {

	weak var mvvmDetailViewControllerDelegate: MVVMDetailViewControllerDelegate?
	...
	@objc private func trackViewURLLabelAction() {
		...
		mvvmDetailViewControllerDelegate?.labelTappedAction(urlString: sender)
