...
class MVPDetailView: UIView {

	weak var mvpDetailViewControllerDelegate: MVPDetailViewControllerDelegate?
	...
	@objc private func trackViewURLLabelAction() {
		...
		mvpDetailViewControllerDelegate?.labelTappedAction(urlString: sender)
